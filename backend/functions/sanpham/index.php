...
<head>
    ...
    <!-- DataTable CSS -->
    <link href="/thucphamchay/assets/vendor/DataTables/datatables.css" type="text/css" rel="stylesheet" />
    <link href="/thucphamchay/assets/vendor/DataTables/Buttons-1.6.3/css/buttons.bootstrap4.min.css" type="text/css" rel="stylesheet" />
</head>
...
EOT;
                ...
                <table id="tblDanhsach" class="table table-bordered table-hover mt-2">
    ...
    <!-- <script src="..."></script> -->
    <!-- DataTable JS -->
    <script src="/thucphamchay/assets/vendor/DataTables/datatables.min.js"></script>
    <script src="/thucphamchay/assets/vendor/DataTables/Buttons-1.6.3/js/buttons.bootstrap4.min.js"></script>
    <script src="/thucphamchay/assets/vendor/DataTables/pdfmake-0.1.36/pdfmake.min.js"></script>
    <script src="/thucphamchay/assets/vendor/DataTables/pdfmake-0.1.36/vfs_fonts.js"></script>
    <script>
